...
layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function(){
	  ...
	  table.render({
		  elem: '#table' ,//table id
		  url: '<%=request.getContextPath()%>/student/datagrid.do',
				method : 'POST', //方式
				page : true,//是否开启分页
				...
				cols : [ [ //标题栏
				{checkbox: true},
				{field : 'name',title : '名字',align : 'center',width : '200'},
				{field : 'sexNm',title : '性别',align : 'center',width : '200',templet: '#sexTpl'},
				{field : 'stateNm',title : '状态',align : 'center',width : '200',templet: '#stateTpl'},
				{field : 'dateBirth',title : '出生年月',align : 'center',sort : true,width : '200'},
				{field : 'createTime',title : '创建时间',align : 'center',sort : true,width : '200'},
				{field : 'updateTime',title : '修改时间',align : 'center',sort : true,width : '200'},
				...
				layer.open({
			        ...
			        ,success: function(layero){
			          ...
			          btn.find('.layui-layer-btn0').on('click', function() {
			        	  ...
			        	  $.ajax({
								url : '<%=request.getContextPath()%>/student/remove.do',
								data : {
									uuid : ids
								},
